...
public class UserController {
	...
	public ModelAndView getUser(@ModelAttribute(SystemConstant.MODEL) UserDTO model, HttpServletRequest request) {
	...
	public ModelAndView registerUser(@ModelAttribute(SystemConstant.MODEL) UserDTO model, HttpServletRequest request) {
